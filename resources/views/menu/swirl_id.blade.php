<!DOCTYPE html>
<html lang="en" x-data="{ flavors: '', price:'', Rprice: 0,  msg: '', show: false }">
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Swirls Delight</title>
...
<body class="bg-no-repeat bg-cover bg-center h-screen p-5 font-PP" x-data="{
                ...
                addToCart() {
                    ...
                    if (anyAdded) {
                        this.popupMessage = 'Swirls Delight added to cart!';
                        this.showPopup = true;
                    } else {
    ...
    <h1 class="text-xl max-[780px]:text-sm mb-4 max-[780px]:mb-0">Swirls Delight Flavors</h1>
    ...
    <div class="flex flex-1 space-x-5 overflow-x-auto  items-center px-2 py-3 no-scrollbar ">
        ...
        <div class="rounded-2xl" @click="selectedFlavor='Blueberry'">
            <div class="bg-white w-58 p-5 drop-shadow-sm flex flex-col justify-center items-center space-y-3 rounded-2xl max-[780px]:space-y-2 max-[780px]:p-4">
                ...
                <div class="bg-[#FFFBFB] shadow-sm rounded-2xl py-6 mt-6 px-1 h-[135px] items-center drop-shadow-sm">
                    <img src="{{ asset('img/blueberrySwirlsDelight.png') }}" alt="Blueberry" class="-mt-15 ml-7 w-[126px] h-[126px]">
        ...
        <div class="rounded-2xl" @click="selectedFlavor='Caramel'">
            <div class="bg-white w-58 p-5 drop-shadow-sm flex flex-col justify-center items-center space-y-3 rounded-2xl max-[780px]:space-y-2 max-[780px]:p-4">
                ...
                <!-- Image -->
                <div class="bg-[#FFFBFB] shadow-sm rounded-2xl py-6 mt-6 px-1 h-[135px] items-center drop-shadow-sm">
                    <img src="{{ asset('img/caramelSwirlsDelight.png') }}" alt="Caramel" class="-mt-15 ml-7 w-[126px] h-[126px]">
        ...
        <div class="rounded-2xl" @click="selectedFlavor='Chocolate'">
            <div class="bg-white w-58 p-5 drop-shadow-sm flex flex-col justify-center items-center space-y-3 rounded-2xl max-[780px]:space-y-2 max-[780px]:p-4">
                ...
                <!-- Image -->
                <div class="bg-[#FFFBFB] shadow-sm rounded-2xl py-6 mt-6 px-1 h-[135px] items-center drop-shadow-sm">
                    <img src="{{ asset('img/chocolateSwirlsDelight.png') }}" alt="Chocolate" class="-mt-15 ml-7 w-[126px] h-[126px]">
        ...
        <div class="rounded-2xl" @click="selectedFlavor='Mango'">
            <div class="bg-white w-58 p-5 drop-shadow-sm flex flex-col justify-center items-center space-y-3 rounded-2xl max-[780px]:space-y-2 max-[780px]:p-4">
                ...
                <!-- Image -->
                <div class="bg-[#FFFBFB] shadow-sm rounded-2xl py-6 mt-6 px-1 h-[135px] items-center drop-shadow-sm">
                    <img src="{{ asset('img/mangoSwirlsDelight.png') }}" alt="Mango" class="-mt-15 ml-7 w-[126px] h-[126px]">
        ...
        <div class="rounded-2xl" @click="selectedFlavor='Strawberry'">
            <div class="bg-white w-58 p-5 drop-shadow-sm flex flex-col justify-center items-center space-y-3 rounded-2xl max-[780px]:space-y-2 max-[780px]:p-4">
                ...
                <!-- Image -->
                <div class="bg-[#FFFBFB] shadow-sm rounded-2xl py-6 mt-6 px-1 h-[135px] items-center drop-shadow-sm">
                    <img src="{{ asset('img/stawberrySwirlsDelight.png') }}" alt="Strawberry" class="-mt-15 ml-7 w-[126px] h-[126px]">
